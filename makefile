...
kernel.bin: boot.o kmain.o VGAdriver.o link.ld
	$(CROSS)/i686-elf-ld -T link.ld boot.o VGAdriver.o kmain.o -o kernel.bin -Map=kernel.map
...
clean:
	rm -f boot.o VGAdriver.o kmain.o kernel.bin kernel.map
